...
import (
	...
	"github.com/wtfutil/wtf/modules/awsbilling"
...
func MakeWidget(
	...
	case "awsbilling":
		settings := awsbilling.NewSettingsFromYAML(moduleName, moduleConfig, config)
		widget = awsbilling.NewWidget(app, pages, settings)
	case "azuredevops":
